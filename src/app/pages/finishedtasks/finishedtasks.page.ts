...
export class FinishedtasksPage implements OnInit {
  ...
  async functionTaskCorrespondence(taskId:any,index:any){
    this.navCtrl.navigateRoot(["/correspondencetasks", {requestId:this.returnTasksArray[index]['requestId'],taskId:taskId,page:5}]);
  }
